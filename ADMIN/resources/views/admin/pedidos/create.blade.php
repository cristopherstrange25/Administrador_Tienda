...
@section('contenido')
<form class="row g-3 needs-validation" method="POST" action="/pedidos" novalidate>
@csrf
  <p></p>
  <p></p>
  <h1>CREAR</h1>
    <div class="col-md-12">
      ...
      <input type="number" class="form-control" id="validationCustom01" name="employees_id" required>
    ...
    <div class="col-md-12">
      ...
      <input type="date" class="form-control" id="validationCustom02" name="order_date" required>
      <div class="valid-feedback">
        Looks good!
      </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="validationCustom04" name="transportation" required>
        <div class="valid-feedback">
          Looks good!
        </div>
        <div class="invalid-feedback">
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="validationCustom05" name="delivery_address" required>
        <div class="valid-feedback">
          Looks good!
        </div>
        <div class="invalid-feedback">
